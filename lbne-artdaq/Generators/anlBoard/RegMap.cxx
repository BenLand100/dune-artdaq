...
//                      Name                               Address     Read Mask  Write Mask  Size
    ...
    instance->fNamed["linkStatus"]              =Register(  0x40000140, 0xFFFFFFFF, 0x00000000, 1 );
    ...
    instance->fNamed["c2cStatus"]               =Register(  0x40000150, 0xFFFFFFFF, 0x00000000, 1 );
    instance->fNamed["c2cControl"]              =Register(  0x40000154, 0xFFFFFFFF, 0x00000007, 1 );
    instance->fNamed["c2cIntrControl"]          =Register(  0x40000158, 0xFFFFFFFF, 0x0000000F, 1 );     
    instance->fNamed["dspStatus"]               =Register(  0x40000160, 0xFFFFFFFF, 0x00000000, 1 );
    instance->fNamed["clockStatus"]             =Register(  0x40000170, 0xFFFFFFFF, 0x00000000, 1 );
    instance->fNamed["clockControl"]            =Register(  0x40000174, 0xFFFFFFFF, 0x00000001, 1 );
    instance->fNamed["ledConfig"]               =Register(  0x40000180, 0xFFFFFFFF, 0x00000003, 1 );     
    instance->fNamed["ledInput"]                =Register(  0x40000184, 0xFFFFFFFF, 0xFFFFFFFF, 1 );     
    ...
    instance->fNamed["mmcm_status"]             =Register(  0x80000020, 0xFFFFFFFF, 0x00000000, 1 );     
    instance->fNamed["module_id"]               =Register(  0x80000024, 0x00000FFF, 0x00000FFF, 1 );     
    instance->fNamed["win_comp_min"]            =Register(  0x80000028, 0x0000FFFF, 0x0000FFFF, 1 );
    instance->fNamed["win_comp_max"]            =Register(  0x8000002C, 0x0000FFFF, 0x0000FFFF, 1 );
    instance->fNamed["c2c_status"]              =Register(  0x80000030, 0xFFFFFFFF, 0x00000000, 1 );     
    instance->fNamed["c2c_intr_control"]        =Register(  0x80000034, 0xFFFFFFFF, 0x0000000F, 1 );
    instance->fNamed["control_status"]          =Register(  0x80000040, 0xFFFFFFFF, 0xFFFFFFFF, 12);     
    ...
    instance->fNamed["k_window"]                =Register(  0x800001C0, 0x000003FF, 0x000003FF, 12);     
    ...
    instance->fNamed["i_window"]                =Register(  0x800002C0, 0x000003FF, 0x000003FF, 12);     
    ...
    instance->fNamed["misc_config"]             =Register(  0x80000408, 0x00730333, 0x00730333, 1 );     
    instance->fNamed["channel_pulsed_control"]  =Register(  0x8000040C, 0x00000000, 0xFFFFFFFF, 1 );
    instance->fNamed["led_config"]              =Register(  0x80000410, 0xFFFFFFFF, 0x00000003, 1 );     
    instance->fNamed["led_input"]               =Register(  0x80000414, 0xFFFFFFFF, 0xFFFFFFFF, 1 );     
    ...
    instance->fNamed["master_logic_status"]     =Register(  0x80000500, 0xFFFFFFFF, 0x00000073, 1 );     
    ...
    instance->fNamed["link_status"]             =Register(  0x80000510, 0xFFFFFFFF, 0x00000000, 1 );     
