...
namespace lbne {
    ...
    void send_command(std::string const & command, std::map<std::string,std::string> & answer);
    ...
    void send_xml(std::string const & xml_frag);
		...
		void send_xml(std::string const & xml_frag,std::map<std::string,std::string> & xml_answers);
