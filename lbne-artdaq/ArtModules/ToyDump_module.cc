...
class lbne::ToyDump : public art::EDAnalyzer {
public:
...
lbne::ToyDump::ToyDump(fhicl::ParameterSet const & pset)
    : EDAnalyzer(pset),
...
lbne::ToyDump::~ToyDump()
{
}

void lbne::ToyDump::analyze(art::Event const & evt)
{
...
DEFINE_ART_MODULE(lbne::ToyDump)
