...
class lbne::TPCScope : public art::EDAnalyzer {
...
lbne::TPCScope::TPCScope(fhicl::ParameterSet const & pset)
: EDAnalyzer(pset),
...
lbne::TPCScope::~TPCScope(){
}

void lbne::TPCScope::analyze(art::Event const & evt){
...
void lbne::TPCScope::dumpPlots(uint rce, uint ch, uint cnt){
  art::ServiceHandle<art::TFileService> tfs;
...
DEFINE_ART_MODULE(lbne::TPCScope)
