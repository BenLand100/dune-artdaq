...
lbne::WFViewer::WFViewer (fhicl::ParameterSet const & ps): 
  art::EDAnalyzer(ps), 
...
void lbne::WFViewer::analyze (art::Event const & e) {
...
void lbne::WFViewer::beginRun(art::Run const &e) { 
...
DEFINE_ART_MODULE(lbne::WFViewer)
