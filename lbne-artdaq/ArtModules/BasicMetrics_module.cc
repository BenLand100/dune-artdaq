...
class lbne::BasicMetrics : public art::EDAnalyzer {
public:
...
lbne::BasicMetrics::BasicMetrics(fhicl::ParameterSet const & pset)
    : EDAnalyzer(pset),
...
lbne::BasicMetrics::~BasicMetrics()
{
   metricMan_.do_stop();
   metricMan_.shutdown();
}

void lbne::BasicMetrics::analyze(art::Event const & evt)
{
...
DEFINE_ART_MODULE(lbne::BasicMetrics)
