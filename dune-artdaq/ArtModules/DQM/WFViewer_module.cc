...
dune::WFViewer::WFViewer (fhicl::ParameterSet const & ps): 
  art::EDAnalyzer(ps), 
...
void dune::WFViewer::analyze (art::Event const & e) {
...
void dune::WFViewer::beginRun(art::Run const &e) { 
...
DEFINE_ART_MODULE(dune::WFViewer)
