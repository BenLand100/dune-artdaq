...
class demo::FragmentWatcher : public art::EDAnalyzer
{
public:
...
demo::FragmentWatcher::FragmentWatcher(fhicl::ParameterSet const & pset)
  : EDAnalyzer(pset),
...
demo::FragmentWatcher::~FragmentWatcher()
{
  if (metricMan != nullptr)
  {
    metricMan->do_stop();
...
void demo::FragmentWatcher::analyze(art::Event const & evt)
{
  events_processed_++;
...
DEFINE_ART_MODULE(demo::FragmentWatcher)
