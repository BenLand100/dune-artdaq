...
dune::detail::RawEventQueueReader::RawEventQueueReader(fhicl::ParameterSet const & ps,
	art::ProductRegistryHelper & help,
	art::SourceHelper const & pm) :
  artdaq::detail::RawEventQueueReader(ps, help, pm)
{
  mf::LogInfo("RawEventQueueReader") << "DuneInput Constructor!";
  for(auto& name : names) {
    ...
    help.reconstitutes<artdaq::Fragments, art::InEvent>(pretend_module_name, "Container" + name);
  }
}
