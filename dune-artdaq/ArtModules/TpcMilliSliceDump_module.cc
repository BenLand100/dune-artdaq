...
class dune::TpcMilliSliceDump : public art::EDAnalyzer {
public:
...
dune::TpcMilliSliceDump::TpcMilliSliceDump(fhicl::ParameterSet const & pset)
: EDAnalyzer(pset),
...
void dune::TpcMilliSliceDump::beginJob()
{
	art::ServiceHandle<art::TFileService> tfs;
	adc_values_ = tfs->make<TH1D>("adc_values","adc_values",4096,-0.5,4095.5);
}

dune::TpcMilliSliceDump::~TpcMilliSliceDump()
{
}

void dune::TpcMilliSliceDump::analyze(art::Event const & evt)
{
...
DEFINE_ART_MODULE(dune::TpcMilliSliceDump)
