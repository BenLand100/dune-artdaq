...
class dune::MilliSliceDump : public art::EDAnalyzer {
public:
...
dune::MilliSliceDump::MilliSliceDump(fhicl::ParameterSet const & pset)
    : EDAnalyzer(pset),
...
dune::MilliSliceDump::~MilliSliceDump()
{
}

void dune::MilliSliceDump::analyze(art::Event const & evt)
{
...
DEFINE_ART_MODULE(dune::MilliSliceDump)
