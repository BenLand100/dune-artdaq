#ifndef dune_artdaq_Generators_PennReceiver_hh
#define dune_artdaq_Generators_PennReceiver_hh
...
#include "dune-artdaq/Generators/pennBoard/PennClient.hh"
#include "dune-artdaq/Generators/pennBoard/PennDataReceiver.hh"
...
typedef struct CalibChannelConfig {
  ...
  private:
    ...
    std::unique_ptr<dune::PennClient> penn_client_;

    bool run_receiver_;
    std::unique_ptr<dune::PennDataReceiver> data_receiver_;
...
#endif /* dune_artdaq_Generators_PennReceiver_hh */
