...
class RceDataReceiver {
 ...
 public:
  ...
  bool retrieve_filled_buffer(RceRawBufferPtr& buffer,
 ...
 private:
  ...
  enum NextReceiveState {
    ReceiveMicrosliceHeader,
  ...
  enum MillisliceState {
    MillisliceEmpty,
    MillisliceIncomplete,
    MicrosliceIncomplete,
    MillisliceComplete
  };
