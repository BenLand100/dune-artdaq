...
private:
  ...
  void setupFEMBFakeWord(size_t iFEMB, unsigned fakeWord, uint32_t expected_femb_fw_version);
  void setupFEMBFakeWaveform(size_t iFEMB, std::vector<unsigned> fakeWaveform, uint32_t expected_femb_fw_version);
