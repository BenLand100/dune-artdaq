...
bool dune::TPCMilliSliceSimulatorWithCopy::getNext_(artdaq::FragmentPtrs & frags)
{
...
uint32_t dune::TPCMilliSliceSimulatorWithCopy::
...
uint8_t* dune::TPCMilliSliceSimulatorWithCopy::
get_start_address_of_third_party_buffer()
{
  return &work_buffer_[0];
}

DEFINE_ARTDAQ_COMMANDABLE_GENERATOR(dune::TPCMilliSliceSimulatorWithCopy) 
