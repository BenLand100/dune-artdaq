...
bool dune::PennReceiver::getNext_(artdaq::FragmentPtrs & frags) {
	...
	artdaq::Globals::metricMan_->sendMetric("PTB Empty Buffer Low Water Mark", empty_buffer_low_mark_, "buffers", 1);
	artdaq::Globals::metricMan_->sendMetric("PTB Empty Buffers Available", empty_buffers_available, "buffers", 1);
	artdaq::Globals::metricMan_->sendMetric("PTB Filled Buffer High Water Mark", filled_buffer_high_mark_, "buffers", 1);
	artdaq::Globals::metricMan_->sendMetric("PTB Filled Buffers Availiable", filled_buffers_available, "buffers", 1);
