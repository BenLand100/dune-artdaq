#ifndef dune_artdaq_Generators_TimingReceiverDebug_hh
#define dune_artdaq_Generators_TimingReceiverDebug_hh

//################################################################################
//# /*
//#      TimingReceiverDebug.hh (goes with: TimingReceiverDebug_generator.cpp)
//#
...
// TimingReceiverDebug_generator.cc.   It is to avoid the uhal verbose messages
...
namespace dune {
class TimingReceiverDebug : public artdaq::CommandableFragmentGenerator {
  public:
    explicit TimingReceiverDebug(fhicl::ParameterSet const & ps);
  ...
  //    void stopHwTimePublisher();
    ...
    // TimingReceiverDebug_generator.cc comments near the constructor.
...
#endif /* dune_artdaq_Generators_TimingReceiverDebug_hh */
