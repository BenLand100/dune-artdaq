...
if ! ENV['DUNEARTDAQ_REPO'] 
  puts "Couldn\'t find DUNEARTDAQ_REPO variable; have you sourced setupDUNEARTDAQ?"
  exit 1
end

basedir = ENV['DUNEARTDAQ_REPO'] 
gendir = basedir + "/dune-artdaq/Generators/"
overlaydir = basedir + "/dune-artdaq/Overlays/"
...
dune-artdaq. However, before doing so, consider (A) editing the source
...
copy of dune-artdaq/tools/fcl/driver.fcl which will use your fragment
