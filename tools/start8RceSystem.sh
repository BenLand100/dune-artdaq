...
echo "BoardReaderMain `hostname` ${DUNEARTDAQ_BR_PORT[2]}" >> $tempFile
echo "BoardReaderMain `hostname` ${DUNEARTDAQ_BR_PORT[3]}" >> $tempFile
echo "BoardReaderMain `hostname` ${DUNEARTDAQ_BR_PORT[4]}" >> $tempFile
echo "BoardReaderMain `hostname` ${DUNEARTDAQ_BR_PORT[5]}" >> $tempFile
echo "BoardReaderMain `hostname` ${DUNEARTDAQ_BR_PORT[6]}" >> $tempFile
echo "BoardReaderMain `hostname` ${DUNEARTDAQ_BR_PORT[7]}" >> $tempFile
