...
function launch() {
  ...
  DemoControl.rb ${enableSerial} -s -c $1 \
    --ssp dunedaq1,${DUNEARTDAQ_BR_PORT[0]},0,1 \
    --eb dunedaq2,${DUNEARTDAQ_EB_PORT[0]} \
    --eb dunedaq2,${DUNEARTDAQ_EB_PORT[1]} \
    --ag dunedaq3,${DUNEARTDAQ_AG_PORT[0]},1 \
    --ag dunedaq3,${DUNEARTDAQ_AG_PORT[1]},1 \
...
Configuration options (init commands):
  ...
  -o <data dir>: specifies the directory for data files [default=/data/dunedaq/data]
